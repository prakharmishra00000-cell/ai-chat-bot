  ...
  return (
    <group>
      ...
      <group ref={novaRef}>
        ...
        <Sparkles count={900} scale={[80, 80, 80]} size={28} speed={3.5} color="#ff007f" opacity={0.85} blending={THREE.AdditiveBlending} />
        <Sparkles count={500} scale={[120, 120, 120]} size={20} speed={2.5} color="#7928ca" opacity={0.65} blending={THREE.AdditiveBlending} />
        <Sparkles count={300} scale={[40, 40, 40]} size={45} speed={5.0} color="#ffffff" opacity={0.9} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
...
function ThemeSolarEruption() {
  ...
  return (
    <group>
      ...
      <group ref={flareRef}>
        <Sparkles count={700} scale={[60, 60, 60]} size={30} speed={4.0} color="#ff4e50" opacity={0.9} blending={THREE.AdditiveBlending} />
        <Sparkles count={600} scale={[80, 80, 80]} size={18} speed={3.0} color="#f9d423" opacity={0.7} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
  ...
  return (
    <group>
      ...
      <group ref={jetRef} position={[0, 0, -80]}>
        <Sparkles count={800} scale={[15, 15, 200]} size={12} speed={6.0} color="#00f2fe" opacity={0.95} blending={THREE.AdditiveBlending} />
        <Sparkles count={500} scale={[25, 25, 160]} size={24} speed={5.0} color="#4facfe" opacity={0.75} blending={THREE.AdditiveBlending} />
      </group>
      <Stars radius={200} count={1000} speed={4.0} />
    </group>
  );
}
...
function ThemeNebulaTempest() {
  ...
  return (
    <group>
      <Stars radius={150} depth={50} count={1500} factor={6} saturation={1} fade speed={2.5} />
      ...
      <group ref={tempestRef}>
        <Float speed={5.0} rotationIntensity={2.0} floatIntensity={1.5}>
          <Cloud opacity={0.5} speed={2.5} width={45} depth={4} segments={25} color="#da22ff" position={[-15, 5, -20]} />
          <Cloud opacity={0.4} speed={2.0} width={50} depth={4} segments={25} color="#9114ff" position={[15, -5, -30]} />
        </Float>
      </group>
    </group>
  );
...
function ThemeHyperdriveWarp() {
  ...
  return (
    <group>
      <group ref={warpRef}>
        <Sparkles count={1200} scale={[40, 40, 300]} size={10} speed={8.0} color="#ffffff" opacity={0.9} blending={THREE.AdditiveBlending} />
        <Sparkles count={800} scale={[25, 25, 200]} size={16} speed={6.5} color="#00c6ff" opacity={0.8} blending={THREE.AdditiveBlending} />
        <Sparkles count={400} scale={[15, 15, 150]} size={28} speed={5.0} color="#0072ff" opacity={0.95} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
...
function ThemeMeteorShower() {
  ...
  return (
    <group>
      <Stars radius={200} count={1200} speed={1.5} />
      <group ref={showerRef} position={[20, 40, -40]}>
        <Sparkles count={700} scale={[6, 80, 6]} size={15} speed={9.0} color="#38ef7d" opacity={0.95} blending={THREE.AdditiveBlending} />
        <Sparkles count={400} scale={[8, 120, 8]} size={22} speed={8.0} color="#11998e" opacity={0.7} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
...
function ThemeBlackHoleVortex() {
  ...
  return (
    <group rotation={[Math.PI / 3.5, 0, 0]}>
      <Stars radius={150} count={1800} speed={0.8} />
      ...
      <group ref={vortexRef} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <Sparkles count={800} scale={[44, 44, 2]} size={12} speed={5.0} color="#f5af19" opacity={0.85} blending={THREE.AdditiveBlending} />
        <Sparkles count={500} scale={[30, 30, 3]} size={20} speed={6.5} color="#ffffff" opacity={0.9} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
...
function ThemeGammaRayBurst() {
  ...
  return (
    <group>
      <Stars radius={150} count={1200} speed={1.2} />
      <ambientLight intensity={0.4} />
      <group ref={systemRef}>
        <pointLight ref={lightRef1} position={[-12, 0, 0]} color="#a8c0ff" distance={120} />
        <Sphere args={[3.5, 32, 32]} position={[-12, 0, 0]}>
          <meshBasicMaterial color="#a8c0ff" />
        </Sphere>
        <Sparkles count={300} scale={[15, 15, 15]} position={[-12, 0, 0]} size={24} speed={4.0} color="#ffffff" opacity={0.8} blending={THREE.AdditiveBlending} />

        <pointLight ref={lightRef2} position={[12, 0, 0]} color="#3f2b96" distance={120} />
        <Sphere args={[3, 32, 32]} position={[12, 0, 0]}>
          <meshBasicMaterial color="#3f2b96" />
        </Sphere>
        <Sparkles count={300} scale={[12, 12, 12]} position={[12, 0, 0]} size={24} speed={3.5} color="#3f2b96" opacity={0.7} blending={THREE.AdditiveBlending} />
      </group>
    </group>
  );
}
...
function ThemeAsteroidStorm() {
  ...
  return (
    <group rotation={[Math.PI / 7, Math.PI / 4, 0]} position={[15, -8, -35]}>
      <Stars radius={200} count={2200} speed={2.0} />
      <pointLight intensity={2500} position={[-40, 40, 40]} color="#fda085" />
      
      <Sphere ref={planetRef} args={[28, 32, 32]}>
      ...
      <group ref={stormRef} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <Sparkles count={1200} scale={[140, 140, 4]} size={8} speed={4.0} color="#f6d365" opacity={0.85} />
        <Sparkles count={600} scale={[160, 160, 6]} size={18} speed={3.5} color="#ffffff" opacity={0.6} />
      </group>
    </group>
  );
}
  ...
  return (
    <group>
      ...
      <group ref={collisionRef}>
        <Sparkles count={1000} scale={[25, 25, 25]} size={20} speed={5.5} color="#00f2fe" opacity={0.9} blending={THREE.AdditiveBlending} />
        <Sparkles count={800} scale={[30, 30, 30]} size={12} speed={4.5} color="#e0e0e0" opacity={0.8} blending={THREE.AdditiveBlending} />
      </group>
      <Stars radius={250} count={1500} speed={3.0} />
    </group>
  );
}
